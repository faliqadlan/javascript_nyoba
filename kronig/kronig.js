...
let x       = [],
    ...
    singleEigen(xmin,xmax,dx,ngrid,v0,vpot,x,idx,efunction,iter,nloop,initE,leb,tgi,tt,vtemp,potensial_function = trianglePotential)
    console.log(vpot)
...
function trianglePotential(xmin,xmax,leb,tgi,tt,x,v0 = 0) {
    xp = x - xmin - leb/ 2;
...
function singleEigen(xmin,xmax,dx,ngrid,v0,vpot,x,idx,efunction,iter,nloop,initE,leb,tgi,tt,vtemp,potensial_function = harmonicPotential)
{
